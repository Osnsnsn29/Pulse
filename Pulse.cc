    ...
    getgenv().Pulse = {
        ['Key'] = {'AukjMoAmYwAlibJuOLJSKItAOrmmNhBh'};  -- WHEN PASTING IN UR KEY, ONLY COPY YOUR KEY DONT COPY THE "SCRIPT_KEY", ONLY YOUR KEY, AND PASTE IT INSIDE OF THE 'YOURKEYHERE'
        ...
        ['Camera Lock'] = {
            ...
            ['Keybind']     = {['Hold'] = false, ['Mode'] = 'Keybind', ['Key'] = 'q', ['Mousebind'] = Enum.UserInputType.MouseButton2};
            ['Prediction']  = {['Enabled'] = true, ['Prediction'] = 0.155};
            ['Style']       = {['First Style'] = 'Elastic', ['Second Style'] = 'Elastic'};
            ['Smoothness']  = {['Enabled'] = true, ['Smoothness'] = 1, ['Air Shot Smoothness'] = 1};
    ...
    -- GOTO THE LUARMOR CHANNEL TO GET UR KEY
